...
_**2. Cells, Tissues, and Organs.**_** **\(4\) Lecture, three hours; discussion, 75 minutes. Enforced requisite: Chemistry 14A or 20A. Introduction to basic principles of cell structure, organization of cells into tissues and organs, and principles of organ systems. Letter grading.
...
105. Hydrology. \(4\) Lecture, three hours. Requisites: course 104, Statistics 12. Role of water in geographic systems: hydrologic phenomena in relation to climate, landforms, soils, vegetation, and cultural processes and impacts on landscape. Field projects required. P/NP or letter grading.
...
**116**. Biogeography of Plant and Animal Invasions. \(4\) Lecture, three hours; reading period, one hour. Requisite: course 1 or 2 or 5. Examination of theories and examples of invasion of new environments by plants and animals introduced through natural processes or by human activity. P/NP or letter grading.
...
148. Economic Geography. \(4\) Lecture, three hours; reading period, one hour. Requisite: course 4. Designed for juniors/seniors. Geographical aspects of economic production and growth. General theory of space-economy. Land-use processes. Location of industry. Regional development. P/NP or letter grading.
...
168. Intermediate Geographic Information Systems. \(4\) Lecture, two hours; laboratory, two hours. Enforced requisite: course 7. Extension of basic concepts presented in course 7. How geographic and spatial analyses inform, integrate, and extend scientific inquiry in physical, life, and social sciences. Discussion of range of decisions and critical judgments necessary to carry out sound spatial analyses. Development of technical proficiency within geographic information systems \(GIS\) environment. P/NP or letter grading.

169. Satellite Remote Sensing and Imaging Geographic Information Systems. \(4\) Lecture, two hours; laboratory, one hour. Enforced requisite: course 7. Introduction to fast-growing field of environmental monitoring from space. Application of Landsat, radar, Global Positioning System \(GPS\), and Earth Observing System satellites to land-use change, oceanography, meteorology, and environmental monitoring. Introduction to digital image-processing and imaging geographic information systems \(GIS\) software. P/NP or letter grading.

170. Advanced Geographic Information Systems. \(4\) Lecture, three hours; discussion, one hour. Enforced requisite: course 168. Introduction to full geographic information systems \(GIS\) functionality, using ARC/INFO on UNIX workstations. Spatial manipulation, query, and computation of datasets carried out in project-oriented approach. P/NP or letter grading.

M171. Introduction to Spatial Statistics. \(4\) \(Same as Statistics M171.\) Lecture, three hours; laboratory, one hour. Requisite: one course from Statistics 10, 11, 12, 13, or 14. Introduction to methods of measurement and interpretation of geographic distributions and associations. P/NP or letter grading.

172. Remote Sensing: Digital Image Processing and Analysis. \(4\) Lecture, three hours; laboratory, one hour. Enforced requisite: course 169. Digital processing methods for manipulating and analyzing image data. Topics include statistical description, geometric and radiometric correction, classification, image enhancement and filtering, and change detection schemes. Reinforcement of procedures presented in lecture with laboratory exercises and student project. P/NP or letter grading.

173. Geographic Information Systems Programming and Development. \(4\) Lecture, two hours; laboratory, two hours. Enforced requisite: course 168. Introduction to fundamental concepts and architecture of programming objects in widely used geographic information systems \(GIS\), and programming in GIS environment. Topics include GIS customization and development using variety of programming languages. Lectures followed by laboratory exercises. P/NP or letter grading.

174. Advanced Remote Sensing. \(5\) Lecture, three hours; laboratory, two hours. Enforced requisites: courses 169, 172. Remote sensing in visible and infrared wavelength regions to understand basic concepts of radiation propagation and interaction with matter, how digital remote sensing images are acquired, and constraints on available data and data analysis. P/NP or letter grading.

177. Field Methods in Physical Geography. \(5\) Lecture, three hours; laboratory, three hours. Not open for credit to students with credit for course M127. Examination of field procedures and concepts used in observation, measurement, analysis, and interpretation of physical phenomena pertinent to natural and built environment. Topics vary from year to year and may include soils, geomorphology, and field methods in geographic information science. May be repeated for credit with topic change. P/NP or letter grading.

## **Regions** {#regions}

180. North America. \(4\) Lecture, three hours; reading period, one hour. Designed for juniors/seniors. Delimitation and analysis of principal geographic regions of U.S. and Canada. P/NP or letter grading.

181. Mexico, Central America, Caribbean. \(4\) Lecture, three hours; reading period, one hour. Designed for juniors/seniors. Study of geographic factors, physical and cultural, that are basic to understanding historical development of Middle America and contemporary economic and cultural geography of Mexico and countries of Central America and West Indies. P/NP or letter grading.

182A. Spanish South America. \(4\) Lecture, three hours; reading period, one hour. Designed for juniors/seniors. Study of geographic factors, physical and cultural, that are basic to understanding historical development of Spanish South America and contemporary economic and cultural geography of individual Spanish-speaking countries. P/NP or letter grading.

182B. Brazil. \(4\) Lecture, three hours; reading period, one hour. Designed for juniors/seniors. Study of geographic factors, physical and cultural, that are basic to understanding historical development of Portuguese South America and contemporary economic and cultural geography of Brazil. P/NP or letter grading.

183. The Mediterranean World. \(4\) Lecture, three hours; reading period, one hour. Designed for juniors/seniors. Study of geographic factors, physical and cultural, that are basic to understanding historical development of Mediterranean region, with emphasis on 1500s to present. Introduction to great disputes in history and ecology centered on this region and character of two shores of Mediterranean basin. P/NP or letter grading.

184. California. \(4\) Lecture, three hours; reading period, one hour. Limited to juniors/seniors. Systematic and regional treatment of geography of California, including physical, cultural, and economic aspects and detailed studies of various regions. P/NP or letter grading.

185. South and Southeast Asia. \(4\) Lecture, three hours; reading period, one hour. Designed for juniors/seniors. Regional synthesis with varying emphasis on people of South or Southeast Asia in their physical, biotic, and cultural environment and its dynamic transformation. P/NP or letter grading.

186. Contemporary China. \(4\) Lecture, three hours; reading period, one hour. Designed for juniors/seniors. Systematic geographic analysis of elements of landscape, resources, population, and socioeconomic characteristics of People’s Republic of China. Dynamics that have led to China’s major role in East Asian and international scene, with special attention to China-Japan and Sino-American relations and their geographic bases. P/NP or letter grading.
